...
"""
accelerate launch \
    --config_file configs/120b-fsdp.yaml \
    sft.py \
    --config configs/120b-sft-lora.yaml \
    --model_name_or_path openai/gpt-oss-120b \
    --packing true packing_strategy wrapped \
    --run_name 120b-lora-eager \
...
def main(script_args, training_args, model_args):
    ...
    # Ensure tokenizer has pad token for consistent sequence lengths
